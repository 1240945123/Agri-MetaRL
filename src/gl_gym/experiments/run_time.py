...
from gl_gym.experiments.gl_predefined_controls import set_matlab_params
import numpy as np
import pandas as pd
...
if __name__ == "__main__":
    ...
    controls = pd.read_csv(RESULT_DIR / 'AgriControl/comparison/matlab/controls_pipe2009.csv').values[:, :6]
    weather = pd.read_csv(RESULT_DIR / 'AgriControl/comparison/matlab/weather_pipe2009.csv').values[:, :]

...
from gl_gym.paths import CONFIG_DIR, MODEL_DIR, RESULT_DIR
...
if __name__ == "__main__":
    ...
    load_path = str(MODEL_DIR / args.project / args.algorithm / args.mode)
    if args.mode == "stochastic":
        save_dir = str(RESULT_DIR / args.project / args.mode / args.algorithm / str(args.uncertainty_scale))
        n_sims = 30
    else:
        save_dir = str(RESULT_DIR / args.project / args.mode / args.algorithm)
        n_sims = 1

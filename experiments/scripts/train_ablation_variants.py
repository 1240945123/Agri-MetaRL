...
Each variant: 5 seeds, 2e6 steps. Output: artifacts/models/AgriControl_ablation/agri_metarl/deterministic/models/.
"""
import os
import sys
...
def main():
    ...
    models_base = os.path.join("artifacts", "models", project, "agri_metarl", "deterministic", "models")

...
Output: artifacts/results/AgriControl/fixed_protocol/trajectory_60d.csv
"""
import os
import sys
import argparse
...
def main():
    ...
    parser.add_argument("--model_dir", type=str, default=None, help="e.g. artifacts/models/AgriControl/agri_metarl/deterministic/models/run1. If None, uses first available run.")
    parser.add_argument("--out_path", type=str, default="artifacts/results/AgriControl/fixed_protocol/trajectory_60d.csv")
    ...
    if model_dir is None:
        default_models = os.path.join("artifacts", "models", "AgriControl", args.algorithm, "deterministic", "models")

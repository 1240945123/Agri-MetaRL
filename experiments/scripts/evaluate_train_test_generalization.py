...
Output: artifacts/results/AgriControl/train_test_generalization/train_test_returns.csv (seed, algo, train_return, test_return).
"""
import os
import sys
import argparse
...
def main():
    ...
    parser.add_argument("--model_root", type=str, default="artifacts/models/AgriControl/agri_metarl/deterministic")
    parser.add_argument("--n_episodes", type=int, default=5)
    parser.add_argument("--out_dir", type=str, default="artifacts/results/AgriControl/train_test_generalization")

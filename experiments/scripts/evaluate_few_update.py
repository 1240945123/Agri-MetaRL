...
Output: artifacts/results/AgriControl/few_update/few_update_returns.csv (method, n_updates, mean_return, std_return).
"""
import os
import sys
import argparse
...
def main():
    ...
    parser.add_argument("--out_dir", type=str, default="artifacts/results/AgriControl/few_update")

...
Output: climate violations + economic metrics per method -> artifacts/results/AgriControl/fixed_protocol/summary.csv
"""
import os
import sys
import argparse
...
def main():
    ...
    parser.add_argument("--model_dirs", type=str, nargs="+", help="e.g. artifacts/models/AgriControl/ppo/deterministic/models/run1")
    parser.add_argument("--algorithm", type=str, default="ppo", choices=list(ALG_MAP))
    parser.add_argument("--n_episodes", type=int, default=5)
    parser.add_argument("--out_dir", type=str, default="artifacts/results/AgriControl/fixed_protocol")

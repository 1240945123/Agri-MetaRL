...
echo - Deterministic PPO: artifacts/results/AgriControl/deterministic/ppo/
echo - Stochastic PPO: artifacts/results/AgriControl/stochastic/ppo/
echo - Rule-based baseline: artifacts/results/AgriControl/deterministic/rb_baseline/ and artifacts/results/AgriControl/stochastic/rb_baseline/
echo.

...
def plot_trajectories():
    ...
    # Load data
    ppo_file = "artifacts/results/AgriControl/deterministic/ppo/dummy-cg4axdls-201059-Amsterdam.csv"
    rb_file = "artifacts/results/AgriControl/deterministic/rb_baseline/rb_baseline-201059-Amsterdam.csv"
...
def plot_uncertainty_analysis():
    ...
    for scale in uncertainty_scales:
        filepath = f"artifacts/results/AgriControl/stochastic/ppo/{scale}/dummy-nbw883du-201059-Amsterdam.csv"

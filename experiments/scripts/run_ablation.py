...
Usage:
  ...
  - Auto: --ablation_base_dir artifacts/models/AgriControl_ablation/agri_metarl/deterministic
          --full_base_dir artifacts/models/AgriControl/agri_metarl/deterministic (for full variant)
"""
import os
import sys
import argparse
...
def main():
    ...
    parser.add_argument("--out_dir", type=str, default="artifacts/results/AgriControl/ablation")
